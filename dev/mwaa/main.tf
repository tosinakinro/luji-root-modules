...
module "iam" {
  source            = "git::https://github.com/tosinakinro/luji-terraform-modules.git//apache_airflow/iam"
...
module "vpc" {
  source = "git::https://github.com/tosinakinro/luji-terraform-modules.git//apache_airflow/vpc"
...
module "security_group" {
  source  = "git::https://github.com/tosinakinro/luji-terraform-modules.git//apache_airflow/security_group"
  vpc_id  = module.vpc.vpc_id
  sg_name = var.security_group_name
}

module "mwaa" {
  source                          = "git::https://github.com/tosinakinro/luji-terraform-modules.git//apache_airflow/mwaa"
  environment_names               = var.environment_names
